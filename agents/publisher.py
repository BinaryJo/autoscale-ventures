...
def deploy_assets(_artifacts):
    ...
    # OpenAPI stubs for four workers
    ...
    write_openapi("tzslots","/api/slots","Generate time slots from a start time",
                  [{"name":"tz","in":"query","required":False,"schema":{"type":"string"}},{"name":"start","in":"query","required":True,"schema":{"type":"string"}},{"name":"blocks","in":"query","required":False,"schema":{"type":"integer"}},{"name":"block_minutes","in":"query","required":False,"schema":{"type":"integer"}}])
    write_openapi("schedule","/api/schedule","Generate recurring schedule dates",
                  [{"name":"period","in":"query","required":True,"schema":{"type":"string"}},{"name":"start","in":"query","required":True,"schema":{"type":"string"}},{"name":"count","in":"query","required":False,"schema":{"type":"integer"}}])
