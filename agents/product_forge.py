...
<title>{kw} — Brain Bridge</title><meta name="viewport" content="width=device-width, initial-scale=1">
<link href="../assets/style.css" rel="stylesheet"></head><body>
<header><a class="brand" href="../">Brain Bridge</a></header><main>
<h1>{kw.title()}</h1>
...
</main><footer>© {datetime.utcnow().year} Brain Bridge</footer></body></html>
"""
...
---
Auto-generated, free **{kw}** by Brain Bridge.
